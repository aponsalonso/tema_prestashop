 ...
 -->			
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-8">
            {if isset($images) && count($images) > 0}
                <!-- thumbnails -->
                <div id="views_block" class="col-lg-4 {if isset($images) && count($images) < 2}hidden{/if}">
            ...
            {/if}
			<!-- product img-->
			<div id="image-block" class="col-lg-8">
				{if $product->new}
					<span class="new-box">
				...
				{/if}
                <div class="r-seller-link r-seller-link-detail">
                    {hook h='displayProductListSeller' id_product=$product->id}
                </div>
                <div class="r_product_share_menu r_product_share_menu_detail col-sm-1 pull-right">
                            ...
                            <li class="">
                                               <span>
                                                 <!--   <span class="menu-img">
                                                    ...
                                                    <span><span  style="float: left;"><img class="social-product" src="{$img_dir}/social.png" /></span></span>
                                               </span>
                                ...
                                <ul style="display: none;" class="submenu-container clearfix first-in-line-xs">
                                    ...
                                    <li><ul>
                                            <li class="social-sharing" data-sharing-image="{$link->getImageLink($product->link_rewrite, $product->id_image, 'home_default')|escape:'html':'UTF-8'}" data-sharing-name="{$product->name}" data-sharing_url="{$link->getProductLink($product)|escape:'html':'UTF-8'}" data-type="pinterest">
                                                <a href="javascript:;">
                                                    <i class="icon-pinterest"></i>
                                                    {l s="Pinterest" mod='socialsharing'}
                                                </a>
                                            </li>
                                            <li class="social-sharing" data-sharing-name="{$product->name}" data-sharing_url="{$link->getProductLink($product)|escape:'html':'UTF-8'}" data-type="google-plus">
                                                <a href="javascript:;">
                                                    <i class="icon-google-plus"></i>
                                                    {l s="Google+" mod='socialsharing'}
                                                </a>
                                            </li>
                                            <li class="social-sharing" data-sharing-name="{$product->name}" data-sharing_url="{$link->getProductLink($product)|escape:'html':'UTF-8'}" data-type="facebook">
                                                <a href="javascript:;">
                                                    <i class="icon-facebook"></i>
                                                    {l s="Share" mod='socialsharing'}
                                                </a>
                                            </li>
                                            <li class="social-sharing" data-sharing-name="{$product->name}" data-sharing_url="{$link->getProductLink($product)|escape:'html':'UTF-8'}" data-type="twitter">
                                                <a href="javascript:;">
		...
		<div class="pb-right-column col-xs-12 col-sm-4 col-md-4">
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
				...
				<div class="box-info-product">
					<div class="content_prices clearfix pull-right">
					...
					<p id="space"></p>
					<div class="product_attributes clearfix pull-left col-lg-12">
						<!-- quantity wanted -->
						{if !$PS_CATALOG_MODE}
    ...
    <div class="col-lg-12">
        <!-- center infos -->
        <div style="margin-top: 55px" class="pb-center-column col-xs-12 col-sm-6">
            {if $product->online_only}
                <p class="online_only">{l s='Online only'}</p>
            {/if}
            <h1 itemprop="name" class="title">{$product->name|escape:'html':'UTF-8'}</h1>
...
<!--             <p id="availability_date"{if ($product->quantity > 0) || !$product->available_for_order || $PS_CATALOG_MODE || !isset($product->available_date) || $product->available_date < $smarty.now|date_format:'%Y-%m-%d'} style="display: none;"{/if}>
            ...
            <!-- Out of stock hook -->
            <div id="oosHook" style="display: none !important;"  {if $product->quantity > 0} style="display: none;"{/if}>
                {$HOOK_PRODUCT_OOS}
            </div>
        ...
        <!-- end center infos-->
        <div style="margin-top: 35px" class="col-sm-6">
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
		...
		{if isset($product)==null && $product->description}
			<!-- More info -->
			<section class="page-product-box">
			...
			<!--end  More info -->
		{/if}
		<div class="header-custom col-xs-12 col-sm-12 col-lg-12"><h4 class="title">Recomendaciones</h4></div>
			...
			{foreach from=$products item=product name=products}
				...
				<li class="ajax_block_product{if $page_name == 'index' || $page_name == 'product'} col-xs-12 col-sm-12 col-md-12{else} col-xs-12 col-sm-12 col-md-4{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} last-in-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} first-in-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0} last-item-of-tablet-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1} first-item-of-tablet-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 0} last-item-of-mobile-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 1} first-item-of-mobile-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloMobile)} last-mobile-line{/if}">
					<div class="product-container" itemscope itemtype="https://schema.org/Product">
						<div class="left-block" style="min-height: {rand(100,220)}px !important;background-image: url({$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'});">
		...
		{if isset($accessories)==null && $accessories}
			<!--Accessories -->
			<section class="page-product-box">
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<!--end Download -->
			{/if}
			{if isset($product)==null && $product->customizable}
			<!--Customization -->
			<section class="page-product-box">
...
<script>
    $(document).ready(function(){
        ...
        $('#space').css('height',$('#image-block').height()-133);
    });

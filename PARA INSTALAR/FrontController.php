...
class FrontControllerCore extends Controller
{
    ...
    public function initHeader()
    {
        ...
        $product_seller_info = Db::getInstance()->executeS("SELECT "._DB_PREFIX_."product_lang.name, "._DB_PREFIX_."marketplace_seller_info.seller_name, "._DB_PREFIX_."marketplace_seller_info.shop_name, "._DB_PREFIX_."marketplace_seller_info.id FROM "._DB_PREFIX_."product_lang inner join "._DB_PREFIX_."marketplace_seller_product on "._DB_PREFIX_."product_lang.name="._DB_PREFIX_."marketplace_seller_product.product_name inner join "._DB_PREFIX_."marketplace_seller_info on "._DB_PREFIX_."marketplace_seller_product.id_seller="._DB_PREFIX_."marketplace_seller_info.id");

        $product_seller = [];
        foreach ($product_seller_info as $key => $value)  {
            $product_seller[ $value['name'] ][0] = $value['id'].'-'.$value['shop_name'].'.jpg';
